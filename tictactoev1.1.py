        ...
        if fieldchart[0][2] != " ": #DIAGONAL2
            if fieldchart[0][2] == fieldchart[1][1] and fieldchart[0][2] == fieldchart[2][0]:
                ...
                if fieldchart[0][2] == "X":
                    ...
                    print(f"{player2name} won! GG!")
                    input()
    if gameison == True: #Only enters the tie decision code if all the winning code above didnt declare gameison as False
...
def maingame():
 ...
 /_  __(_)___/_  __/___ _____/_  __/___  ___
  / / / / ___// / / __ `/ ___// / / __ \/ _ |
 / / / / /__ / / / /_/ / /__ / / / /_/ /  __/
/_/ /_/\___//_/  \__,_/\___//_/  \____/\___/  Version 1.1\n
By ᴋᴇʟʟᴇᴋᴇʀᴇʟʟ 2020\n
...
""")
    ...
    while gameison == True:
        ...
        input()
while True: # The game itself lul
    maingame()
    if gameison == False: #gameison is false when a winner has been picked / the game tied
        while True:
            con = input("Do you want to continue playing? Press Enter to continue or type q,l,e,quit,leave or exit to quit the game.") #asks whether the game should continue or end
            if con == "q" or con == "l" or con == "quit" or con == "leave" or con == "Leave" or con == "Quit" or con == "e" or con == "E" or con == "exit" or con == "Exit":
                quit() #exits the game
            elif con == "": #con is "" if the users want to continue playing
                gameison = True #gameison is set back to true in order for the game to continue (used in maingame())
                fieldchart = [[" "," "," "],[" "," "," "],[" "," "," "]] #the grid is reset
                break #throws the process out of the inner loop in order to go back to maingame() and play
            else:
                continue #if the user input something different than the commands in order to leave and didnt just press Enter he's asked to decide again
        continue
